...
|---|---|---|
| 🔧 [**ETL Pipeline**](https://github.com/YOUR_USERNAME/project-1) | End-to-end data pipeline from raw sources to warehouse | Airflow · dbt · BigQuery |
| 📊 [**Sales Dashboard**](https://github.com/YOUR_USERNAME/project-2) | Interactive business intelligence report | SQL · Power BI |
